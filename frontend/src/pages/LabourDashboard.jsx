...
const LabourDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-4 pb-8">
      {/* Header */}
      <div className="flex justify-between items-center mb-4">
        <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center text-2xl font-semibold text-gray-700 shadow">
      ...
      <p className="text-center text-gray-800 font-semibold mb-6 text-lg">
        {user?.name || 'User'}
      </p>
